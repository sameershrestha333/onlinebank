...
public class TransactionServiceImpl implements TransactionService {
	...
	public List<SavingsTransaction> findSavingsTransactionList(String username) {
		User user = userService.findByUsername(username);
		List<SavingsTransaction> savingsTransactionList = user.getSavingsAccount().getSavingsTransaction();
	...
	@Override
	public void bewtweenAccountsTransfer(String transferFrom, String transferTo, String amount,
	...
	public List<Recipient> findRecipientList(Principal principal) {
		 ...
		 * )//lambda expression .collect(Collectors.toList());
		 * 
	...
	public Recipient findRecipientByName(String recipientName) {
		return recipientDao.findRecipientByName(recipientName);
	}
